...
//
//int Ea[MXHEIGHT][MXWIDTH],Eb[MXHEIGHT][MXWIDTH];
...
//	//Create binary index trees Ea for the first rendering
//	glReadPixels(0,0,ImageWidth,ImageHeight,GL_RGB,GL_UNSIGNED_BYTE,NULL);
//	GLubyte* ptr = (GLubyte*)glMapBuffer(GL_PIXEL_PACK_BUFFER,GL_READ_ONLY);
//	memset(Ea,0,sizeof(Ea));
//	for(int i = 0; i < ImageHeight; ++i){
//		for(int j = 0; j < ImageWidth; ++j){
//			if(*ptr != 255 || *(ptr+1) != 0 || *(ptr+2) != 255){
//				//if(sum(Ea,j+1,i+1,j+1,i+1)==0)
//					update(Ea,j+1,i+1,1);
//			}else{
//				//if(sum(Ea,j+1,i+1,j+1,i+1)==1)
//					//update(Ea,j+1,i+1,-1);
//			}
//			ptr+=3;
//		}
...
//	drawTorus(0.0,0.0,1.0);
//	//Create the binary index tree Eb for the second rendering
//	glReadPixels(0,0,ImageWidth,ImageHeight,GL_RGB,GL_UNSIGNED_BYTE,NULL);
...
//		for(int j = 0; j < ImageWidth; ++j){
//			if(*ptr != 255 || *(ptr+1) != 0 || *(ptr+2) != 255){
//				//if(sum(Eb,j+1,i+1,j+1,i+1)==0)
//					update(Eb,j+1,i+1,1);	
//			}else{
//				//if(sum(Eb,j+1,i+1,j+1,i+1)==1)
//					//update(Eb,j+1,i+1,-1);
//			}
//			ptr+=3;
//		}
